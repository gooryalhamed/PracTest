...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { name: @test.name, score: @test.score, time: @test.time } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { name: @test.name, score: @test.score, time: @test.time } }
